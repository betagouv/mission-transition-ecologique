...
export default class ConfigBaserow extends ConfigCommon {
  ...
  private static _TABLE_ID_CONTACT = 397740
  ...
  public static get CONTACT_ID() {
    return parseInt(this.getEnvValue('BASEROW_TABLE_ID_CONTACT', this._TABLE_ID_CONTACT.toString()))
  }
  ...
  public static get FAQ_ID() {
    return parseInt(this.getEnvValue('BASEROW_TABLE_ID_FAQ', this._TABLE_ID_FAQ.toString()))
  }
