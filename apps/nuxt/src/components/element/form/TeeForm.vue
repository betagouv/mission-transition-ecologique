...
import { type ReqResp, TrackId, FormDataType, InputFieldUnionType, ProjectType, ProgramTypeForFront } from '@/types'
...
interface Props {
  dataId?: string
  showTitle?: boolean
  dataSlug?: ProgramTypeForFront['id'] | ProjectType['slug']
