...
const programTaxAdvantage = computed(() => currentExternalProgram.value?.[`montant de l'avantage fiscal`])
const programLoan = computed(() => currentExternalProgram.value?.[`montant du prêt`])
const programDuration = computed(() => currentExternalProgram.value?.[`durée de l'accompagnement`])
const programLoanDuration = computed(() => currentExternalProgram.value?.[`durée du prêt`])
const programProvider = computed(() => currentExternalProgram.value?.['opérateur de contact'])
const programEndValidity = computed(() => currentExternalProgram.value?.[`fin de validité`])
