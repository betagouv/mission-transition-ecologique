...
export const frDict = {
  ...
  form: {
    ...
    phoneContactCE:
      'Votre demande à été transmise au service public Conseillers-Entreprises. Un conseiller vous contactera par téléphone dans les 5 jours pour échanger sur votre besoin et répondre à vos questions',
