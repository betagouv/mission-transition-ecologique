...
import { ProgramType, QuestionnaireData } from '@/types'
...
export class ProgramManager {
  ...
  private async _getFromApi(questionnaireData: QuestionnaireData = {}): Promise<ResultApi<ProgramType[]>> {
    return await new ProgramApi(questionnaireData).get()
  }

  private async _getOneFromApi(id: string): Promise<ResultApi<ProgramType>> {
