import { ProgramTypeWithEligibility } from '@tee/data'
...
export type OpenAPISafeProgram = Omit<ProgramTypeWithEligibility, "conditions d'éligibilité"> & OpenAPISafeEligibility
