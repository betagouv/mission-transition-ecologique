...
const isCatalogDetail = navigationStore.isByRouteName(RouteName.CatalogProjectDetail)|| navigationStore.isByRouteName(RouteName.CatalogProjectFromProgramDetail) 
