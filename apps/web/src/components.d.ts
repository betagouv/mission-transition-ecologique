...
declare module 'vue' {
  export interface GlobalComponents {
    ...
    TeeDsfrNavigation: typeof import('./components/nav/TeeDsfrNavigation.vue')['default']
    TeeDsfrNavigationMenu: typeof import('./components/nav/TeeDsfrNavigationMenu.vue')['default']
