...
// --- OPTION A : Extension du type pour supporter les colonnes Baserow ---
...
const projetsFiltres = computed({
  get: () => {
    ...
    // Filtrage sécurisé (on gère le fait que Baserow renvoie un objet ou un string)
  ...
  <div class="p-8">
    <div class="flex justify-between items-center mb-6">
      ...
      <button v-if="isModified" @click="saveChanges"
        class="bg-blue-800 hover:!bg-blue-600 text-white px-4 py-2 font-bold transition-colors rounded shadow-sm">
