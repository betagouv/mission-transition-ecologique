  ...
  <div class="p-8">
    <div class="flex justify-between items-center mb-6">
      ...
      <button v-if="isModified" @click="saveChanges"
       class="bg-blue-800 text-white hover:bg-blue-100 px-5 py-2.5 rounded-md font-bold shadow-sm border-2 border-transparent hover:border-blue-200 transition-all duration-300 ease-in-out">
