...
import { ContactId, ContactBodyAttributes, ContactUpdateAttributes } from '../../../domain/types'
 ...
 */
export const addBrevoContact: ContactRepository['create'] = async (email: string, attributes: ContactBodyAttributes) => {
