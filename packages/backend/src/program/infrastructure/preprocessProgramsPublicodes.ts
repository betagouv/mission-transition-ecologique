...
const setObjectives = (publicodesData: PublicodesInputData, questionnaireData: QuestionnaireData) => {
  if (questionnaireData.priority_objective) {
    ...
    publicodesData[PublicodesKeys.BuildingOwner] = questionnaireData.building_property == BuildingProperty.Rents || questionnaireData.building_property == BuildingProperty.No ? YesNo.No : YesNo.Yes
  }
}
