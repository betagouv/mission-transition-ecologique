...
export default class OperatorService {
  ...
  public createOpportunity(opportunity: Opportunity, program: Program): Promise<Result<ContactId, Error> | false> {
    return this._operator.createOpportunity(opportunity, program)
  }
