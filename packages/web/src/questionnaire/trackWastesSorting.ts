...
import { TrackComponent, TrackId, YesNo, WasteSorting } from '@/types'
...
export const wastesSorting: Track = {
  ...
  options: [
    {
      value: YesNo.Yes,
      questionnaireData: { wastes_sorting: WasteSorting.InPlace },
      title: { fr: 'Oui' },
    ...
    {
      value: YesNo.No,
      questionnaireData: { wastes_sorting: WasteSorting.CanImprove },
    ...
    {
      value: YesNo.Unknown,
      questionnaireData: { wastes_sorting: WasteSorting.Unknown },
