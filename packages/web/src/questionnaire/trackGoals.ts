...
export const goals = {
  ...
  options: [
    {
      // WIP
      value: { ...objectifsPrioritaires, 'questionnaire . objectif prioritaire . est impact carbone': true },
    ...
    {
      value: { ...objectifsPrioritaires, 'questionnaire . objectif prioritaire . est ma performance énergétique': true },
    ...
    {
      value: { ...objectifsPrioritaires, 'questionnaire . objectif prioritaire . est la gestion des déchets': true },
    ...
    {
      value: { ...objectifsPrioritaires, 'questionnaire . objectif prioritaire . est faire des économies': true },
      title: { fr: 'Economies' },
      label: {
    ...
    {
      value: { ...objectifsPrioritaires, 'questionnaire . objectif prioritaire . est la mobilité durable': true },
    ...
    {
      value: { ...objectifsPrioritaires, 'questionnaire . objectif prioritaire . est rénover mon bâtiment': true },
    ...
    {
      value: { ...objectifsPrioritaires, 'questionnaire . objectif prioritaire . est ma performance environnementale': true },
    ...
    {
      disabled: true,
      value: { ...objectifsPrioritaires, 'questionnaire . objectif prioritaire . est investir durable': true },
    ...
    {
      disabled: true,
      value: { ...objectifsPrioritaires, 'questionnaire . objectif prioritaire . est je ne sais pas encore': true },
      title: { fr: 'Autre' },
