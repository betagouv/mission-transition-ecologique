<template>
  <div
    ...
    <div class="fr-col fr-col-7">
      ...
      <p>
        L’eau a un coût, qui risque d’augmenter dans les années à venir. 
    ...
    <div class="fr-col fr-col-4 fr-col-offset-1">
      <figure
        ...
        <div class="fr-content-media__img fr-ratio-32x9">
          <img 
            ...
            src="/images/home/water.svg"
            alt="TEE - illustration - water" />
        </div>
      </figure>
    </div>
  </div>
