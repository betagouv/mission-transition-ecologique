<template>
  <div
    ...
    <div class="fr-col fr-col-4">
      <figure
        class="fr-content-media fr-content-media--md tee-home-img fr-my-0"
        role="group" 
        aria-label="© Transition Ecologique des entreprises">
        <div class="fr-content-media__img fr-ratio-1x1">
          <img 
            class="fr-responsive-img" 
            src="/images/home/electric.svg"
            alt="TEE - illustration - electric" />
        </div>
      </figure>
    </div>
    <div class="fr-col fr-col-7 fr-col-offset-1">
      ...
      <h1>
        Diminuer votre facture d’éléctricité
      </h1>
      <p>
